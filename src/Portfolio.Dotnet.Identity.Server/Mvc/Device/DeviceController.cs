...
using Portfolio.Dotnet.Identity.Server.Mvc.Device.Models;

namespace Portfolio.Dotnet.Identity.Server.Mvc.Device
{
    [Authorize]
    [SecurityHeaders]
        ...
        IOptions<IdentityServerOptions> options) : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var vm = await BuildViewModelAsync(userCode.ToString());
            if (vm == null)
            {
                return View("Error");
            }
